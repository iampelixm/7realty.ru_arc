...
var buttonCallBackMob2 = document.getElementsByClassName('content-for-life-mobile__button'); // Подать заявку в блоке для кого
...
if(buttonCallBackMob2.length) {
	buttonCallBackMob2[0].addEventListener( "click" , function(){showSellPop(this)}, false);
	buttonCallBackMob2[1].addEventListener( "click" , function(){showSellPop(this)}, false);
}
...
var buttonRegCode1 = document.getElementsByClassName('content-object-card-information-button-details'); // показать Подробнее
...
if(buttonRegCode1.length) {
	buttonRegCode1[0].addEventListener( "click" , function(){showInfo(this)}, false);
}
if(buttonCloseRegCode.length) {
