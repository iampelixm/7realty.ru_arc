...
// 	enterPop[0].classList.add('d-none');
// }
var buttonRegCode1 = document.getElementsByClassName('content-specials-link__button'); // показать Подробнее
...
if(priceElM.length) {
	priceElM[0].addEventListener( "click" , function(){showNextEl(this)}, false); //
}
if(locationElM.length) {
	locationElM[0].addEventListener( "click" , function(){showNextEl(this)}, false); //
}
if(roomsElM.length) {
	roomsElM[0].addEventListener( "click" , function(){showNextEl(this)}, false); //
}
if(squareElM.length) {
	squareElM[0].addEventListener( "click" , function(){showNextEl(this)}, false); //
}
...
function hideMapM(el){
	...
	el.nextElementSibling.nextElementSibling.nextElementSibling.classList.remove('d-none');
}
...
if(hideMapMobile.length) {
	hideMapMobile[0].addEventListener( "click" , function(){hideMapM(this)}, false); //
}
if(showMapMobile.length) {
	showMapMobile[0].addEventListener( "click" , function(){showMapM(this)}, false); //
}
// // прокрутка
// function showY(){
