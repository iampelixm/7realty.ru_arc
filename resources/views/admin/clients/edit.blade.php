        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    <h2>{{ trans('admin.admin-users-edit') }}</h2>
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" action="{{ route('admin.settings.clients.post_edit', $user->id) }}"
                        method="post">
                        @csrf
                            ...
                            <div class="form-controls">
                                ...
                                <div class="col-lg-10">
                                    <select name="role" class="input-sm form-control input-s-sm inline">
                                        ...
                                        <option value="block" @if ($user->role === 'block') selected="" @endif>Гость - доступ запрещен
                                        </option>
