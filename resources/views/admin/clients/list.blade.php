        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-title">
                    <h5>{{ __('admin.menu-settings-clients') }}</h5>
                    <div class="ibox-tools">
                        <a href="{{ route('admin.settings.clients.new') }}"  >
                            ...
                            <tr class="aj-shure-container">
                                ...
                                <td class="aj-hide">
                                    <div class="text-right">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.settings.clients.edit', $user->id) }}" class="btn-white btn btn-xs"><i class="far fa-edit"></i></a>
                                        </div>
                                        <a class="btn btn-delete delete-alert"
                                           data-action="{{ route('admin.settings.clients.post_delete',[$user->id]) }}"
