...
@section('content')
    <div class="ibox-title">
        <h5>{{ __('admin.comments_edit') }}</h5>
    </div>
    <div class="ibox-content">
        <form action="{{ route('admin.comments.update', ['type' => $type, 'id' => $id, 'comment' => $comment->id]) }}" enctype="multipart/form-data" method="POST" role="form">
            @csrf
