...
@section('content')
    <div class="ibox-title">
        <h5>{{ __('admin.comments_list') }}: @if (isset($object)) {{ $object->name }} @endif</h5>
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="buttons__">
                                ...
                                <a href="{{ route('admin.comments.edit', ['type' => $type, 'id' => $object->id, 'comment' => $item->id]) }}">
                                    <i class="far fa-edit"></i>
                                </a>
                                <a href="{{ route('admin.comments.delete', ['type' => $type, 'id' => $object->id, 'comment' => $item->id]) }}" style="color: red;">
