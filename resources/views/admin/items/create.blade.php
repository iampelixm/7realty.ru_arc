        ...
        <form action="{{ route('admin.items.store') }}" enctype="multipart/form-data" method="POST" role="form">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <select class="js-example-basic-multiple-type form-control required" name="type_id" id="type_id" onchange="changeType()" required="">
                    <option></option>
            ...
            <div class="form-group">
                ...
                <select class="js-example-basic-multiple form-control required" name="categories[]" multiple="multiple" id="category-select" required="">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control" id="longitude" required="" name="longitude" placeholder="{{ __('admin.item_longitude') }}"
                           value="{{ old('longitude') ?? '' }}" >
                        </div>
                    </div>
