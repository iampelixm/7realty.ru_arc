                        ...
                        <tbody>
                            ...
                            @foreach ($item->all_options as $option)
                                ...
                                <tr id="row_{{ $option->id }}">
                                    ...
                                    <td>
                                        {{ $option->name }}
                                        <input type="hidden" name="option[{{ $option->id }}][option]"
                                            value="{{ $option->id }}">
                                    </td>
                                    <td>
                                        @if ($option->method_input == 'hand')
                                            <input type="text" class="form-control"
                                                name="option[{{ $option->id }}][value]" value="{{ $option->value }}">
                                        @endif

                                        @if ($option->method_input == 'select')
                                            @php $valuesarr=json_decode($option->values, true) @endphp
                                            <select class="form-control" name="option[{{ $option->id }}][value]"
                                                value="{{ $option->value }}">
                                    ...
                                    <td>
                                        <a class="ml-3 btn btn-sm btn-danger"
                                            onclick="$('#row_{{ $option->id }}').remove()">Удалить</a>
                                    </td>
                                </tr>
                            @endforeach
