<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="params[category]" id="capegory">
                <option value="pokupka" {{ ($page->params->category ?? '') == 'pokupka' ? 'selected' : '' }}>
                    Все о покупке квартиры
                </option>
                <option value="kompleksi" {{ ($page->params->category ?? '') == 'kompleksi' ? 'selected' : '' }}>
                    Информация о комплексах
                </option>
                <option value="o-nas" {{ ($page->params->category ?? '') == 'o-nas' ? 'selected' : '' }}>
                    О нас
                </option>
                <option value="investicii" {{ ($page->params->category ?? '') == 'investicii' ? 'selected' : '' }}>
                    Инвестиции
                </option>
            </select>
        </div>
