    ...
    <div class="ibox-content">
        <form action="{{ route('admin.residences.store') }}" enctype="multipart/form-data" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="{{ __('admin.residence_name') }}" required="" 
                       value="{{ old('name') ?? '' }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" class="form-control" name="all_flats" placeholder="{{ __('admin.item_all_rooms') }}"
               value="{{ old('all_flats') ?? 0 }}" required="">
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input class="form-control" type="date" value="" id="example-datetime-local-input" name="build_at" required="">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="video_url" placeholder="{{ __('admin.video_url') }}"  value="{{ old('video_url') ?? '' }}">
            </div>

            <div class="form-group">
                <label for="">{{ __('admin.item-category-select') }}</label>
                <select class="js-example-basic-multiple form-control" name="categories[]" multiple="multiple" id="category-select" required="">
            ...
            <div class="form-group">
                ...
                <select class="js-example-basic-multiple form-control" name="area_id" required="">
                    ...
                    @foreach($areas as $rez)
                        <option value="{{ $rez->id }}" @if (isset($area_id) && ($area_id == $rez->id)) selected @endif>{{ $rez->name }}</option>
                    @endforeach
                </select>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="text" class="form-control" id="latitude" name="latitude" required="" placeholder="{{ __('admin.item_latitude') }}"
                           value="{{ old('latitude') ?? '' }}" >
                        </div>

                        <div class="col-sm-3">
                            <label for="">{{ __('admin.item_longitude') }}</label>
                            <input type="text" class="form-control" id="longitude" name="longitude" required="" placeholder="{{ __('admin.item_longitude') }}"
                           value="{{ old('longitude') ?? '' }}" >
                        </div>
