        ...
        <form action="{{ route('admin.residences.store') }}" enctype="multipart/form-data" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" class="form-control" name="all_flats"
                    placeholder="{{ __('admin.item_all_rooms') }}" value="{{ old('all_flats') ?? 0 }}" required="">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input class="form-control" type="date" value="" id="example-datetime-local-input" name="build_at"
                        required="">
