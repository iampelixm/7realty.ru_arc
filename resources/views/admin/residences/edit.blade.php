...
@section('content')
    ...
    <div class="ibox-content">
        <form action="{{ route('admin.residences.update', $residence->id) }}" enctype="multipart/form-data" method="POST" role="form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="number" step="1" class="form-control" name="all_flats" placeholder="{{ __('admin.residence_all_rooms') }}"
             ...
             <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="date" value="@if ($residence->build_at != ''){{ date('Y-m-d', strtotime($residence->build_at)) }}@endif" id="example-datetime-local-input" name="build_at" required="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="locationField">
                  <input
                    ...
                    type="text"
                    name="address"
                    value="{{ old('address') ?? $residence->address ?? 0 }}"
                    required=""
                  />
                </div>
            </div>
                ...
                <div style="display: block;">
                    @if ($residence->images != null)
                        @foreach($residence->images as $image)
                            <img src="{{ url('storage/residences/'.$residence->id.'/'.$image->file) }}" style="max-height: 150px; padding: 20px;">
                        @endforeach
                    @endif
                </div>
