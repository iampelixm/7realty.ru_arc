...
@section('content')
    <div class="ibox-title">
        <h2>{{ __('admin.type_edit') }}</h2>
    </div>
    <div class="ibox-content">
        <form action="{{ route('admin.type.update', $type->id) }}" enctype="multipart/form-data" method="POST"
            role="form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <input type="text" class="form-control" placeholder="Slug" value="{{ $type->slug ?? '' }}"
                            disabled="">
                    </div>
                    <div class="col-lg-6">
                        Изменить url
