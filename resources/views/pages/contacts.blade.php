...
<!-- main content -->
    ...
    <div class="office-content py-5 d-none d-md-block">
      <div class="row row-cols-3 no-gutters">
        ...
        <div class="col">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2889.789544898569!2d39.72408981549581!3d43.59009977912349!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40f5cbda9d00d883%3A0xd35a1151541a4eac!2z0YPQuy4g0JPQvtGA0YzQutC-0LPQviwgNTMsINCh0L7Rh9C4LCDQmtGA0LDRgdC90L7QtNCw0YDRgdC60LjQuSDQutGA0LDQuSwg0KDQvtGB0ZbRjywgMzU0MDAw!5e0!3m2!1sru!2sru!4v1604319025831!5m2!1sru!2sru" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    ...
    <div class="office-content py-5 d-none d-md-block">
      <div class="row row-cols-3 no-gutters">
        ...
        <div class="col">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d287520.4779147746!2d37.38609385146485!3d55.73672023576093!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2sru!4v1601409719372!5m2!1sru!2sru" width="100%" height="100%" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
        </div>
      </div>
    </div>
    ...
    <div class="application-content my-5 d-none d-md-block">
      ...
      <div class="application-content-input-div row my-3 no-gutters">
        <div class="col-12 py-2">
          ...
          <input class="application-content-input-div__input" type="text" name="name" id="name" value="" placeholder="Андрей">
        </div>
        <div class="col-12 row no-gutters">
          <div class="col py-2 pr-2">
            <p class="application-content-input-div__p">Ваш номер телефона:</p>
            <input class="application-content-input-div__input mask" type="tel" name="phone" id="phone" value="" placeholder="+7 977 194-73-51">
          </div>
          <div class="col py-2 pl-2">
            <p class="application-content-input-div__p">Ваш e-mail:</p>
            <input class="application-content-input-div__input" type="email" name="email" id="email" value="" placeholder="example@main.com">
          </div>
        </div>
      </div>
      ...
      <div class="application-content-check-div py-3">
        <div class="row no-gutters align-items-center">
          ...
          <div class="col-10"><label class="application-content-check-div__label" for="check">Вы соглашаетесь с условиями обработки персональных данных (<a href="#">ознакомиться</a>)</label></div>
        </div>
       <!--  </form> -->
      </div>
    ...
    <div class="application-content-mobile my-5 d-md-none">
      <div class="application-content-mobile-form col-11 mx-auto">
        ...
        <div class="col py-2">
          <p class="application-content-input-div__p">Ваш номер телефона:</p>
          <input class="application-content-input-div__input mask" type="tel" name="phone" value="" placeholder="+7 977 194-73-51">
        </div>
        <div class="col py-2">
          <p class="application-content-input-div__p">Ваш e-mail:</p>
          <input class="application-content-input-div__input" type="text" name="email" value="" placeholder="example@main.com">
        </div>
        ...
        <div class="application-content-check-div py-3">
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-10"><label class="application-content-check-div__label" for="checkm">Вы соглашаетесь с условиями обработки персональных данных (<a href="#">ознакомиться</a>)</label></div>
          </div>
        </div>
        <div class="application-content-supp-div text-center">
          <p><span>*</span> Поля обязательны для заполнения</p>
