...
@section('content')
    ...
    <div class="content-specials content-specials_position">
      ...
      <div class="content-specials-list">
        <div class="content-specials-list-div"><h3 class="content-specials-list-div__h3">{{ $category->name }}</h3></div>
        ...
        <div class="slider-custom__three owl-carousel px-5">
          @foreach($category->offerItems as $item)
            ...
            <div class="content-specials-list-slider-info">
              ...
              <div class="content-specials-price"><p class="content-specials-price__p"><a href="@if ($item->slug != null){{ route('site.item.get', $item->slug) }} @endif">{{ $item->name }}</a></p></div>
              <div class="content-specials-adress">
                ...
                <div><p class="content-specials__p">{{ $item->address }}</p></div>
              </div>
              <div class="content-specials-pref">
                  ...
                  <div class="content-specials-pref-list-info">
                    <div class="content-specials-pref-list-info__ico">
                      <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.1587 4.64981V1.91163H8.89426V2.90781L6.49997 1.06592L0 6.06627L1.3618 7.83646L2.02858 7.32351V11.934H5.87575V8.55593H7.27606V11.934H10.9715V7.32351L11.6383 7.83646L13 6.0663L11.1587 4.64981ZM10.2089 11.1714H8.03865V7.79332H5.11311V11.1714H2.79117V6.73684L6.5 3.88385L10.2088 6.73684V11.1714H10.2089ZM11.4988 6.76703L6.5 2.92152L1.50122 6.76703L1.06943 6.20574L6.5 2.02807L9.65689 4.45663V2.67424H10.3961V5.02531L11.9305 6.20574L11.4988 6.76703Z" fill="black"/>
                      </svg>
                    </div>
                ...
                <div class="content-specials-pref-list">
                  ...
                  <div class="content-specials-pref-list-info">
                    ...
                    <div class="content-specials-pref-list-info__ico">
                      <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.7833 11.9167H9.68955L9.39922 11.0459C10.4422 11.0017 11.2654 10.144 11.2667 9.10002V8.01669H11.4833C11.8415 8.01737 12.1324 7.72758 12.133 7.36943C12.1336 7.09388 11.9599 6.8481 11.7 6.75656V6.06669C11.7 5.94704 11.603 5.85002 11.4833 5.85002H10.8333V0.866691C10.8333 0.747037 10.7363 0.650024 10.6167 0.650024H7.58333C7.46368 0.650024 7.36667 0.747037 7.36667 0.866691V1.96736C6.62114 2.07496 6.06756 2.71342 6.06667 3.46669V3.90002C6.06667 4.01968 6.16368 4.11669 6.28333 4.11669H8.88333C9.00299 4.11669 9.1 4.01968 9.1 3.90002V3.46669C9.09911 2.71342 8.54552 2.07496 7.8 1.96736V1.08336H10.4V5.85002H9.75C9.63035 5.85002 9.53333 5.94704 9.53333 6.06669V6.71669H1.51667C1.15768 6.71669 0.866667 7.0077 0.866667 7.36669C0.866667 7.72568 1.15768 8.01669 1.51667 8.01669H1.73333V9.10002C1.73461 10.144 2.55778 11.0017 3.60078 11.0459L3.31045 11.9167H0.216667C0.0970125 11.9167 0 12.0137 0 12.1334C0 12.253 0.0970125 12.35 0.216667 12.35H12.7833C12.903 12.35 13 12.253 13 12.1334C13 12.0137 12.903 11.9167 12.7833 11.9167ZM8.66667 3.46669V3.68336H6.5V3.46669C6.5 2.86839 6.98504 2.38336 7.58333 2.38336C8.18163 2.38336 8.66667 2.86839 8.66667 3.46669ZM10.8333 6.28336H11.2667V6.71669H10.8333V6.28336ZM9.96667 6.28336H10.4V6.71669H9.96667V6.28336ZM1.51667 7.58336C1.39701 7.58336 1.3 7.48635 1.3 7.36669C1.3 7.24704 1.39701 7.15002 1.51667 7.15002H11.4833C11.603 7.15002 11.7 7.24704 11.7 7.36669C11.7 7.48635 11.603 7.58336 11.4833 7.58336H1.51667ZM4.17712 11.9167H3.76718L4.05622 11.05H4.46615L4.17712 11.9167ZM4.63407 11.9167L4.92288 11.05H8.07712L8.36593 11.9167H4.63407ZM8.82288 11.9167L8.53385 11.05H8.94378L9.23282 11.9167H8.82288ZM3.68333 10.6167C2.84611 10.6157 2.16761 9.93725 2.16667 9.10002V8.01669H10.8333V9.10002C10.8324 9.93725 10.1539 10.6157 9.31667 10.6167H3.68333Z" fill="black"/>
                        <path d="M3.25001 8.44995H2.81667C2.69702 8.44995 2.60001 8.54696 2.60001 8.66662C2.60001 8.78627 2.69702 8.88328 2.81667 8.88328H3.25001C3.36966 8.88328 3.46667 8.78627 3.46667 8.66662C3.46667 8.54696 3.36966 8.44995 3.25001 8.44995Z" fill="black"/>
                        <path d="M5.41666 8.44995H4.11666C3.99701 8.44995 3.89999 8.54696 3.89999 8.66662C3.89999 8.78627 3.99701 8.88328 4.11666 8.88328H5.41666C5.53631 8.88328 5.63333 8.78627 5.63333 8.66662C5.63333 8.54696 5.53631 8.44995 5.41666 8.44995Z" fill="black"/>
                        <path d="M6.28333 4.55005C6.16368 4.55005 6.06667 4.64706 6.06667 4.76672V5.41672C6.06667 5.53637 6.16368 5.63338 6.28333 5.63338C6.40299 5.63338 6.5 5.53637 6.5 5.41672V4.76672C6.5 4.64706 6.40299 4.55005 6.28333 4.55005Z" fill="black"/>
                        <path d="M7.15 5.19995C7.03035 5.19995 6.93333 5.29696 6.93333 5.41662V6.06662C6.93333 6.18627 7.03035 6.28329 7.15 6.28329C7.26965 6.28329 7.36667 6.18627 7.36667 6.06662V5.41662C7.36667 5.29696 7.26965 5.19995 7.15 5.19995Z" fill="black"/>
                        <path d="M8.01667 4.55005C7.89702 4.55005 7.8 4.64706 7.8 4.76672V5.41672C7.8 5.53637 7.89702 5.63338 8.01667 5.63338C8.13632 5.63338 8.23334 5.53637 8.23334 5.41672V4.76672C8.23334 4.64706 8.13632 4.55005 8.01667 4.55005Z" fill="black"/>
                        <path d="M8.88334 5.19995C8.76368 5.19995 8.66667 5.29696 8.66667 5.41662V6.06662C8.66667 6.18627 8.76368 6.28329 8.88334 6.28329C9.00299 6.28329 9.1 6.18627 9.1 6.06662V5.41662C9.1 5.29696 9.00299 5.19995 8.88334 5.19995Z" fill="black"/>
                      </svg>
                    </div>
                    <div class="content-specials-pref-list-info__text">{{ trans_choice('site.bath_rooms', $item->bath_rooms, ['value' => $item->bath_rooms])  }}</div>
                    @endif
                  </div>
                </div>
              </div>
              <div class="content-specials-choice">
                <div>
                  <div class="content-specials-price-info"><p class="content-specials-price-info__p">{{ number_format($item->price, 0, ",", " ") }} ₽</p></div>
                  <div class="content-specials-link"><button class="content-specials-link__button" onclick="showModal({{ $item->id }})">Отправить запрос</button></div>
                </div>
                <div>
                  <div class="content-specials-heart" onclick="setFavorites({{ $item->id }})"><i class="@if(in_array($item->id, $massFav)) fas @else far @endif fa-heart"></i><!--<i class="fas fa-heart"></i>--></div>
                </div>
              </div>
            </div>
    ...
    <div class="content-partners content-partners_position content-partners_display_block">
      <div class="content-partners-title"><h2 class="content-partners-title__h2">Наши партнеры</h2></div>
      <div class="content-partners-logos">
        <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 align-items-center justify-content-center no-gutters px-2">
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p1.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p4.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p7.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p10.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p13.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p2.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p5.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p8.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p11.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p14.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p3.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p6.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p9.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p12.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p15.png" alt="partner"></div>
        </div>
        ...
        <div class="d-none row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 justify-content-center w-100">
          ...
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p12.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p15.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p16.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p17.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p18.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p19.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p20.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p21.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p22.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p23.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p24.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p25.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p26.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p27.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p28.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p29.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p30.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p31.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p32.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p33.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p34.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p35.png" alt="partner"></div>
          <div class="col-12 col-sm-4 col-lg-2 text-center"><img class="img-fluid img-fluid--partners" src="/users/image/partners/p36.png" alt="partner"></div>
        </div>
      </div>
    </div>
