  ...
  <div class="row no-gutters justify-content-between px-3">
    <div class="col-12 col-md-8 px-3 px-md-0">
      <div class="slider-content">
        ...
        <h4 class="big-slide-image-div__h4" onclick="setFavorites({{ $item->id }})" ><i class="@if(in_array($item->id, $massFav)) fas @else far @endif fa-heart"></i></h4>
      </div>
 ...
 <div class="col-12 col-md-4 px-2 px-md-none">
  <div class="content-object-card-information">
    ...
    <div class="content-object-card-information-pdf">
      <div class="content-object-card-information-pdf-image"><a href="{{ route('site.item.getPdf', $item->slug) }}" target="_blank"><img src="{{ asset('users/image/pdf.jpg') }}" alt="pdf"></a></div>
      <div  class="content-object-card-information-pdf-info"><a href="{{ route('site.item.getPdf', $item->slug) }}" target="_blank">Лот № {{ $item->id }}</a></div>
  </div>
  ...
  <div class="content-object-card-information-list-text">
    <div class="content-object-card-information-list-text-tile">@if($item->type_order == 'sale') Цена @elseif ($item->type_order == 'orenda') Аренда в месяц @endif</div>
    <div class="content-object-card-information-list-text-info">{{ number_format($item->price, 0, ",", " ") }} ₽</div>
</div>
</div>
<div class="content-object-card-information-list">
  <div class="content-object-card-information-list-img">
...
<div class="row no-gutters">
  ...
  <div class="content-object-card-information-input-name col-12 col-sm-6 col-md-12 col-lg-6 pr-none pr-sm-1 pr-md-none pr-lg-1"><p>Ваше имя:</p><input class="content-object-card-information__input" type="text" name="name" id="name" value="" placeholder="Андрей"></div>
  <div class="content-object-card-information-input-name col-12 col-sm-6 col-md-12 col-lg-6"><p>Ваш номер телефона:</p><input class="content-object-card-information__input mask" type="tel" name="name" id="phone" value="" placeholder="+7 977 194-73-51"></div>
</div>
<div class="content-object-card-information-input-name"><p>Ваш e-mail:</p><input class="content-object-card-information__input_email" type="email" name="name" id="email" value="" placeholder="example@main.com"></div>

<p class="pop-table-enter__p text-center"  id="formOrderShowError" style="color: red;"></p>
<div class="content-object-card-information-buttons"><button class="content-object-card-information-button-show" onclick="sendOrderShow({{ $item->id }}, 'Объект')" style="     background: #0076C1;">Узнать подробнее</button></div>
<div class="content-object-card-information-buttons"><button class="content-object-card-information-button-show " style="    background: #007882;" onclick="sendOrderShow({{ $item->id }}, 'Объект')">Назначить показ</button></div> 
    ...
    <div class="content-object-card-parametr-list col-11 col-xl-12">
      <ul class="content-object-card-parametr-list__ul row row-cols-1 row-cols-md-2 row-cols-lg-3">
        @foreach ($itemoptions ?? [] as $key => $value)
            @if($key <10)
                <li class="content-object-card-parametr-li col">{{ $value->option_title }} - {{ $value->value_title }}</li>
            @endif
        @endforeach
...
<div class="content-object-card-parametr-list__button col-12 text-center col-md-11 text-md-left">
  <button class="content-object-card-information-button-details content-object-card-parametr-list__button-info btn_info">Узнать подробнее</button>
</div>

<div class="content-object-card-parametr-list__button col-12 text-center col-md-11 text-md-left">
  @if($item->video_url)
    <a href="{{ $item->video_url }}" target="_blank">
      <button  class="content-object-card-parametr-list__button-info content-object-card-parametr-list__button-info--video btn_show" >Видеотур</button>
    </a>
  @endif
</div>
</div>
    ...
    <div class="content-object-card-feedback-slider slider-custom__four owl-carousel px-5">
      ...
      @foreach($item->commentsActive as $key => $comment)
        <div class="content-object-card-feedback-slider-info">
          <div class="content-object-card-feedback-slider-info-title content-object-card-feedback-slider-info-title--{{ $colorArr[$key % 4] }}"><i class="far fa-user"></i>{{ $comment->name }}</div>
...
<div class="object-card-request row no-gutters">
  <div class="content-object-card-request content-object-card-request_position row justify-content-between no-gutters py-3 col-11 col-xl-12 no-gutters">
  ...
  <div class="content-object-card-request-input col-11 col-md-5 col-lg-2 mx-auto mx-lg-0 py-3">
      ...
      <input class="content-object-card-request-input__input" type="text" name="name" id="name_form" value="" placeholder="Андрей">
  </div>
  <div class="content-object-card-request-input col-11 col-md-5 col-lg-2 mx-auto mx-lg-0 py-3">
      <p class="content-object-card-request-input__p">Ваш номер телефона:</p>
      <input class="content-object-card-request-input__input mask" type="tel" name="phone" id="phone_form" value="" placeholder="+7 977 194-73-51">
  </div>
  <div class="content-object-card-request-input col-11 col-md-5 col-lg-2 mx-auto mx-lg-0 py-3">
      <p class="content-object-card-request-input__p">Ваш e-mail:</p>
      <input class="content-object-card-request-input__input" type="email" name="email" id="email_form" value="" placeholder="example@main.com">
  </div>
  ...
  <div class="content-object-card-request-button col-11 col-lg-2 mx-auto text-center mx-lg-0 py-3">
    <p class="pop-table-enter__p text-center"  id="formOrderShowFormError" style="color: red;"></p>
      <button class="content-object-card-request-button__button btn_blue" onclick="sendOrderShowForm({{ $item->id }})">Отправить</button>
  </div>
</div>
</div>
