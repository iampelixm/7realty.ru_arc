        ...
        <div class="col-12 col-md-4 px-2 px-md-none">
            <div class="content-object-card-information">
                ...
                <div class="content-object-card-information-pdf">
                    ...
                    <div class="content-object-card-information-pdf-info"><a href="{{ route('site.item.getPdf', $item->slug) }}" target="_blank">Лот №
                            {{ $item->id }}</a></div>
                </div>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="content-object-card-information-input-name col-12 col-sm-6 col-md-12 col-lg-6 pr-none pr-sm-1 pr-md-none pr-lg-1">
                        <p>Ваше имя:</p><input class="content-object-card-information__input" type="text" name="name" id="name" value="" placeholder="Андрей">
                    </div>
                    <div class="content-object-card-information-input-name col-12 col-sm-6 col-md-12 col-lg-6">
                        <p>Ваш номер телефона:</p><input class="content-object-card-information__input mask" type="tel" name="name" id="phone" value="" placeholder="+7 977 194-73-51">
                    </div>
                </div>
                <div class="content-object-card-information-input-name">
                    <p>Ваш e-mail:</p><input class="content-object-card-information__input_email" type="email" name="name" id="email" value="" placeholder="example@main.com">
                </div>

                <p class="pop-table-enter__p text-center" id="formOrderShowError" style="color: red;"></p>
                <div class="content-object-card-information-buttons"><button class="content-object-card-information-button-show" onclick="sendOrderShow({{ $item->id }}, 'Объект')" style="     background: #0076C1;">Узнать
    ...
    <div class="row no-gutters">
        ...
        <div class="content-object-card-parametr-list col-11 col-xl-12">
            <ul class="content-object-card-parametr-list__ul row row-cols-1 row-cols-md-2 row-cols-lg-3">
                ...
                @if ($key < 10) <li class="content-object-card-parametr-li col">{{ $value->option_title }} -
        ...
        <div class="content-object-card-parametr-list__button col-12 text-center col-md-11 text-md-left">
            <button class="content-object-card-information-button-details content-object-card-parametr-list__button-info btn_info">Узнать
                подробнее</button>
        </div>
    ...
    <div class="row no-gutters">
        ...
        <div class="content-object-card-feedback-slider slider-custom__four owl-carousel px-5">
            ...
            <div class="content-object-card-feedback-slider-info">
                <div class="content-object-card-feedback-slider-info-title content-object-card-feedback-slider-info-title--{{ $colorArr[$key % 4] }}">
