@extends('pages.item_mobile.common')

@section('item_card')
@include('pages.item_mobile.parts.slider_info_novostroyka')
@show
...
@section('content')
        ...
        <div class="row no-gutters justify-content-between px-3">
            ...
            <div class="col-12 col-md-4 px-2 px-md-none">
                <div class="content-object-card-information">
                    @include('pages.item_mobile.parts.slider_info_novostroika')
                    @include('pages.item_mobile.parts.slider_request_form')
    ...
    @include('pages.item_mobile.parts.comments')
    @include('pages.item_mobile.parts.request_form')
