            ...
            <div class="col-12 col-md-8">
                ...
                <h4 class="big-slide-image-div__h4"><i class="far fa-heart"></i></h4> -->
                    ...
                    @foreach ($residence->imagesActive as $key => $image)
                        <div class="item"><img src="{{ url('storage/residences/' . $residence->id . '/' . $image->file) }}" />
                        </div>
                    @endforeach
                ...
                <div class="content-object-card-information">
                    ...
                    <div class="content-object-card-information-list">
                        ...
                        <div class="content-object-card-information-list-text">
                            ...
                            <div class="content-object-card-information-list-text-info">
                                {{ date('Y', strtotime($residence->build_at)) }}
                            </div>
                        </div>
                    </div>
                    <div class="content-object-card-information-list">
                        ...
                        <div class="content-object-card-information-list-text">
                            ...
                            <div class="content-object-card-information-list-text-info">{{ $residence->items->count() }}
                            </div>
                        </div>
                    </div>
                    <div class="row no-gutters">
                        ...
                        <div class="content-object-card-information-input-name col-12 col-sm-6 col-md-12 col-lg-6">
                            <p>Ваш номер телефона:</p><input class="content-object-card-information__input mask" type="tel"
                                name="phone" id="phone" value="" placeholder="+7 977 194-73-51">
                        </div>
                    </div>
                    ...
                    <div class="content-object-card-information-buttons"><button
                            class="content-object-card-information-button-details "
                            style="    background: #007882;">Назначить
                            показ</button></div>
                </div>
            </div>
        </div>
    ...
    <div class="object-card-info container">
        ...
        <div class="content-residential-form d-md-block mt-4">
            ...
            <div class="row no-gutters px-3 px-xl-0 m-3">
                ...
                @endphp
                <div class="content-residential-form-sort col-12 text-right">сортировать по: <a
                        href="{{ $newurl }}">цене
