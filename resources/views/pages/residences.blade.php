    ...
    <div class="content-residential-form d-md-block mt-4">
        ...
        <div class="col-12 row row-cols-2 no-gutters">
          <div class="col-12 col-lg-10 no-gutters">
            ...
            <div class="row row-cols-4 justify-content-between no-gutters flex-column flex-lg-row">
              <div class="content-residential-form-input col-auto row no-gutters  mb-3 mb-lg-0">
               ...
               <div class="content-residential-form-select col-auto row no-gutters  mb-3 mb-lg-0">
                  <select class="pl-3 content-residential-form-input2 select-custom select-custom--small" type="text" name="area" placeholder="Район">
            ...
            <div class="col row no-gutters mb-3 mb-lg-0 mx-auto m-lg-0 filter-input">
              <div class="content-residential-form-down content-residential-form-down-default row no-gutters price-form  mb-3 mb-lg-0">
              ...
              <div class="content-residential-form-down content-residential-form-down-default row d-none no-gutters location-form">
              ...
              <div class="content-residential-form-down content-residential-form-down-default row no-gutters rooms-form">
                <div class="col row no-gutters">
                  <div class="col-10">
                    <input class="" type="text" name="roomsfrom" placeholder="от 1 комнаты" value="@if(isset($filter['roomsfrom'])){{ $filter['roomsfrom'] }}@endif">
                  </div>
                  <div class="col-2">
                ...
                <div class="col row no-gutters">
                  <div class="col-10">
                    <input class="" type="text" name="roomsto" placeholder="до 3 комнат" value="@if(isset($filter['roomsto'])){{ $filter['roomsto'] }}@endif">
                  </div>
                  <div class="col-2">
                     @include('components.svg.filter_rooms')
                  </div>
      ...
      <div class="row no-gutters px-3 px-xl-0 m-3">
       ...
       @php 
        ...
        @endphp
        <div class="content-residential-form-sort col-6 text-right">сортировать по: <a href="{{ $newurl }}">цене 
