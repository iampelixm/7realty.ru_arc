    ...
    <div class="container goldcontainer firstcontainer">
        <div class="contentwrapper">
            <div class="sevengoldbox" style="margin-bottom: 40px;">
                ...
                <div class="boxinner">
                    <div class="boxintro">
                        <p class="ceoword">Дорогие Друзья!<br><br>

                            Меня зовут Сергей Гоголев<br>
                            и я основатель компании <span class="textgold">Seven!</span><br><br>

                            Компания <span class="textgold">Seven</span> родилась в далеком, но от этого не менее жарком и
                            солнечном июле 2007 года. И летние
                            солнечные эмоции времени основания, предопределили настроение, с которым мы ведем
                            бизнес!<br><br>
