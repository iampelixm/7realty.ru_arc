                <form action="#" method="POST" enctype="application/x-www-form-urlencoded" class="w-100 top-form">
                    <div class="row border-gold rounded-pill align-items-center overflow-hidden"
                        ...
                        <div class="col" >
                            <input style="width: 240px" type="text" name="address" id="address" placeholder="Населенный пункт, улица, дом"
                                class="form-control py-2 rounded-pill">
                        </div>
                        <div class="bg-gold" style="width: 2px; height: 18px;">&nbsp;</div>

                        <div class="col" style="amax-width: 100px;">
                        ...
                        <div class="col " style="amax-width: 80px;">
                        ...
                        <div class="col bg-gold">
                            <input type="submit" class="form-control py-2 rounded-pill" value="Подать заявку">
                        </div>
                    </div>
                    <p align="right" class="text-small text-right mt-2" style="font-size: 9px">
