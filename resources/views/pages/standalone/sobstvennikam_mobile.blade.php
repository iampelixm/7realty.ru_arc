    ...
    <div class="page-sobstvennikam">
        <section class="section-offer">
            <div class="container">
                ...
                <div class="section-offer__people-wrapper">
            ...
            <div class="section-offer__form-containerr">
                <div class="section-offer__form-wrapper">
                    <form action="#" method="POST" enctype="application/x-www-form-urlencoded" class="section-offer__form">
                        ...
                        <div class="section-offer__form-button-wrapper">
                            <input type="submit" class="section-offer__form-button" value="Подать заявку">
                        </div>
                </div>
            </div>
        ...
        <section class="section-bullets">
            ...
            <div class="containers">
                <div class="section-bullets__bullets-wrapper slidethis owl-carousel" data-items="1" data-nav="true"
                    ...
                    <a href="#section_ocenka" class="section-bullets__bullet">
                        ...
                        <div class="section-bullets__buttons-wrapper">
                            <div href="#section_ocenka" class="section-bullets__button">
                                ОЦЕНИТЬ
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#section_personal_broker" class="section-bullets__bullet">
                        ...
                        <div class="section-bullets__buttons-wrapper">
                            <div href="#" class="section-bullets__button">
                                Получить помощь
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="#section_marketing" class="section-bullets__bullet">
                        ...
                        <div class="section-bullets__buttons-wrapper">
                            <div href="#section_marketing" class="section-bullets__button">
                                ознакомиться
                            </div>
                        </div>
                    </a>
        ...
        <section class="section-ocenka" id="section_ocenka">
            <div class="container">
                ...
                <div class="section-ocenka__text-wrapper">
                    <p>
                        Наш эксперт сравнит сделки с аналогичными параметрами за последние полгода и даст точное
                        заключение
        ...
        <section class="section-marketing" id="section-marketing">
            <div class="section-marketing__darkner"></div>
            <div class="container">
        ...
        <section class="section-broker">
            <div class="container">
                ...
                <div class="section-broker__description">
                    Наш эксперт сравнит сделки с аналогичными параметрами
                    за последние 6-12 месяцев и предоставит экспертное
                    заключение по рыночной стоимости
                ...
                <div class="section-broker__words-wrapper">
        ...
        <section class="section-staging">
            <div class="container">
                <div class="section-staging__description">
        ...
        <section class="section-jur">
            <img src="/users/image/mobile/page-sobstvennikam-section-jur-img1.png" alt="" class="section-jur__overimage">
            <div class="container">
            ...
            <div class="section-jur__dogovor-wrapper">
                <div class="container">
                    ...
                    <div class="section-jur__dogovor-text2">
                        Эксклюзивный договор гарантирует ускоренную продажу объекта недвижимости за максимальную
                        цену
                    </div>
        ...
        <section class="section-form">
            ...
            <div class="container">
                <form action="" class="section-form__form" id="form-sobstvennikam">
                    <input type="name" class="section-form__input" name="name" id="name" required placeholder="Ваше имя">
                    ...
                    <textarea class="section-form__input" name="comment" id="comment" placeholder="Комментарий"
                        rows="3"></textarea>
                </form>
            </div>
