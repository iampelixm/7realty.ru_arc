                ...
                @foreach ($category_life as $category)
                    ...
                    <div class="content-for-life-hover__div">
                        @foreach ($category->children as $subcategory)
                            <a class="content-for-life-hover__a" href="@if ($category->slug !=
                                null) {{ route('site.get_category', $subcategory->slug) }} @endif">{{ $subcategory->name }}</a><span> | </span>
                        @endforeach
                    </div>
                @endforeach
        ...
        <div class="content-for-business col">
            ...
            <div class="content-for-business-hover content-for-business-hover_position">
                ...
                @foreach ($category_bizness as $category)
                    ...
                    <div class="content-for-life-hover__div">
                        @foreach ($category->children as $subcategory)
                            <a class="content-for-life-hover__a" href="@if ($subcategory->slug !=
                                null) {{ route('site.get_category', $subcategory->slug) }} @endif">{{ $subcategory->name }}</a><span> | </span>
                        @endforeach
                    </div>
                @endforeach
        ...
        <div class="content-for-life-mobile-hover">
            ...
            @foreach ($category_life as $category)
                ...
                <div class="content-for-life-mobile__div">
                    @foreach ($category->children as $subcategory)
                        <a class="content-for-life-mobile__a" href="@if ($category->slug !=
                            null) {{ route('site.get_category', $subcategory->slug) }} @endif">{{ $subcategory->name }}</a><span> | </span>
                    @endforeach
                </div>
            @endforeach
    ...
    <div class="content-for-business-mobile">
        <div class="content-for-life-mobile-hover">
            ...
            @foreach ($category_bizness as $category)
                ...
                <div class="content-for-life-mobile__div">
                    @foreach ($category->children as $subcategory)
                        <a class="content-for-life-mobile__a" href="@if ($subcategory->slug !=
                            null) {{ route('site.get_category', $subcategory->slug) }} @endif">{{ $subcategory->name }}</a><span> | </span>
                    @endforeach
                </div>
            @endforeach
