...
<footer class="main-footer main-footer_position">
  ...
  <div class="desktop-footer-content d-none d-md-block">
    <div class="main-footer-logo">
      <h2 class="main-footer-logo__h2 main-footer-logo-h2_position_center">Seven - счастливое число вашей сделки</h2>
      ...
      <div class="">
        <div class="row no-gutters">
          <div class="col text-left">
            ...
            <p class="main-footer-info__p"><a href="#"><i class="fas fa-map-marker-alt"></i> Москва, Знаменка д. 13,
                стр. 3</a></p>
          </div>
          <div class="col text-center">
            <h3 class="main-footer-info__h3">Офис в Сочи</h3>
            <p class="main-footer-info__p"><a href="#"><i class="fas fa-map-marker-alt"></i> г. Сочи ул. Горького д.
                53</a></p>
          </div>
          <div class="col text-right">
            <h3 class="main-footer-info__h3"><a href="email:info@7realty.ru">info@7realty.ru</a></h3>
            <h4 class="main-footer-info__h4 text-nowrap"><a href="tel:+79857000077"><i class="fas fa-phone-alt"></i> + 7
                (985) 700-00-77</a></h4>
      ...
      <div class="">
        ...
        <div class="row no-gutters">
          <div class="col">
            ...
            <h3 class="footer-links-div__h3"><a
                href="@if($category->slug != null){{ route('site.get_category', $category->slug) }}@endif"
                style="text-decoration: none; color: white;">{{ $category->name }}</a></h3>
              @foreach($category->children as $subcategory)
              <p class="footer-links-div__p"><a
                  href="@if($category->slug != null){{ route('site.get_category', $subcategory->slug) }}@endif">{{ $subcategory->name }}</a>
              </p>
              @endforeach
          ...
          <div class="col">
            <div class="row no-gutters">
              ...
              <div class="col">
                ...
                <p class="footer-links-div__p"><a href="{{ route('site.get_service', 'agency') }}">Агентские услуги</a>
                </p>
                <p class="footer-links-div__p"><a href="{{ route('site.get_service', 'analitics') }}">Консалтинг и
                    аналитика</a></p>
                <p class="footer-links-div__p"><a href="{{ route('site.get_service', 'managment') }}">Управление
                    продажами</a></p>
                <p class="footer-links-div__p"><a href="{{ route('site.get_service', 'support') }}">Юридическое
                    сопровождение</a></p>
              </div>
            </div>
            <div class="row justify-content-end socials-fixed">
              ...
              <div class="social-liks__div text-center">
                <a class="mx-auto my-3" href="#"><img class="fb-icon" src="/users/image/fb.png" alt="fb"></a>
              </div>
              <!-- <div class="col-4 col-lg-3 social-liks__div text-left"> -->
              <div class="social-liks__div text-left ml-3">
                <a class="mx-auto my-3" href="#"><img class="yt-icon" src="/users/image/yt.png" alt="yt"></a>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="mobile-footer-content d-md-none">
    ...
    <div class="mobile-footer-content-locations-contacts">
      <h5 class="mobile-footer-content-locations-contacts__h5"><a href="#" class="text-white">заказать звонок</a></h5>
    </div>
    ...
    @foreach($category_life as $category)
    <div class="mobile-footer-content-for-life">
      <p class="mobile-footer-content-for-life__p"><a
          href="@if($category->slug != null){{ route('site.get_category', $category->slug) }}@endif"
    ...
    @foreach($category->children as $subcategory)
    <div class="mobile-footer-content-for-life">
      <a class="mobile-footer-content-for-life__a"
        href="@if($category->slug != null){{ route('site.get_category', $subcategory->slug) }}@endif">{{ $subcategory->name }}</a>
    </div>
    @endforeach
    ...
    <div class="mobile-footer-content-for-life mobile-footer-content-for-life_display_flex">
      ...
      <div>
        ...
        <div><a class="mobile-footer-content-for-life__a" href="{{ route('site.agency') }}">Агентские услуги</a></div>
        <div><a class="mobile-footer-content-for-life__a" href="{{ route('site.analitics') }}">Консалтинг и
            аналитика</a></div>
        <div><a class="mobile-footer-content-for-life__a" href="{{ route('site.managment') }}">Управление продажами</a>
        </div>
