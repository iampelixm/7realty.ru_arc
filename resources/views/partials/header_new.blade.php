<header class="main-header amain-header-desktop-content main-header_position" style="font-size: 14px; font-family: Geometria; amargin-bottom: 70px">
    ...
    <div class="main-header-desktop-content acontainer d-none d-md-block" style="margin-top: 26px;">
        <div class="amain-header-desktop-content position-relative">
            <div class="position-absolute" style="top: 30px">
                <div class="slogan" style=" line-height: 24px; font-size: 18px; letter: 20%; color: #333; font-weight: 400;">СЧАСТЛИВОЕ ЧИСЛО<br>ВАШЕЙ СДЕЛКИ</div>
            </div>
