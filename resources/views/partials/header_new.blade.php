<header class="main-header main-header_position">
  		<div class="main-header-desktop-content container d-none d-md-block">
	  		<div class="main-header-upper-div row">
          		...
          		<div class="header-logo-ui col">
            		<div class="header-logo-buttons header-logo-buttons_position">
              			<button class="header-button__button header-button__button_position-sell text-nowrap">Купить/Продать</button>
               			<button class="header-button__button header-button__button_position-rent text-nowrap">Сдать/Арендовать</button>
            		</div>
	            	<!-- Логин Без входа-->
                    @guest
                    ...
                    <div class="col">
                      <a href="{{ route('logout') }}"
                        ...
                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <path d="M17.5217 10.1739C17.8337 10.1739 18.087 9.92067 18.087 9.60867V2.82607C18.0869 1.26835 16.8197 0 15.2609 0H2.82607C1.26723 0 0 1.26835 0 2.82607V23.1739C0 24.7316 1.26723 25.9999 2.82607 25.9999H15.2609C16.8197 25.9999 18.0869 24.7316 18.0869 23.1739V16.3913C18.0869 16.0793 17.8337 15.826 17.5217 15.826C17.2097 15.826 16.9565 16.0793 16.9565 16.3913V23.1739C16.9565 24.1088 16.1957 24.8695 15.2609 24.8695H2.82607C1.89118 24.8695 1.13042 24.1088 1.13042 23.1739V2.82607C1.13042 1.89118 1.89118 1.13042 2.82607 1.13042H15.2609C16.1957 1.13042 16.9565 1.89118 16.9565 2.82607V9.60867C16.9565 9.92067 17.2097 10.1739 17.5217 10.1739Z" fill="black"/>
                          <path d="M25.4347 12.4348H7.34783C7.03583 12.4348 6.78259 12.688 6.78259 13C6.78259 13.312 7.03583 13.5652 7.34783 13.5652H25.4347C25.7467 13.5652 26 13.312 26 13C26 12.688 25.7467 12.4348 25.4347 12.4348Z" fill="black"/>
                        <path d="M25.8338 12.602L22.4425 9.21074C22.222 8.9903 21.8637 8.9903 21.6432 9.21074C21.4228 9.43117 21.4228 9.78954 21.6432 10.01L24.6344 13.0011L21.6432 15.9922C21.4228 16.2127 21.4228 16.571 21.6432 16.7915C21.754 16.9011 21.8987 16.9565 22.0434 16.9565C22.1881 16.9565 22.3328 16.9011 22.4425 16.7926L25.8338 13.4013C26.0542 13.1808 26.0542 12.8225 25.8338 12.602Z" fill="black"/>
                          </g>
                          <defs>
                          <clipPath id="clip0">
              ...
              <i class="fas fa-map-marker-alt fa-map-marker-alt_position"></i> {{ $current_city_title }}<i class="fas fa-chevron-down fa-chevron-down_position"></i>
            </p>
	  				<div class="drop-down-menu drop-down-menu___col_1">
  						<div>
  							@foreach($cities as $city)
                            <p class="drop-down-menu__p"><a class="drop-down-menu__a" href="{{ route('site.change_city', $city->id) }}">{{ $city->name }}</a></p>
                            @endforeach
  						</div>
                    </div>
				  </div>
                ...
                <div class="main-header-navi main-header-navi_position show-drop-down">
                    <p class="main-header-navi__p"><a href="{{ route('site.res.residences', 'all') }}">Жилые&nbsp;комплексы</a><i class="fas fa-chevron-down fa-chevron-down_position"></i></p>
                    <div class="drop-down-menu drop-down-menu___col_2">
                        <div>
                            <div>
                                <p class="drop-down-menu__p"><a class="drop-down-menu__a" href="{{ route('site.res.residences', 'all') }}">Все комплексы</a></p>
            ...
            <div class="main-header-navi main-header-navi_position show-drop-down">
                    <p class="main-header-navi__p"><a href="@if ($category->slug) {{ route('site.get_category', $category->slug) }} @endif">{{ $category->name }}</a><i class="fas fa-chevron-down fa-chevron-down_position"></i></p>
             <div class="drop-down-menu drop-down-menu___col_2">
                <div>
                    <div>
      ...
      <div class="main-header-mobile-content-active d-none d-md-none">
        <div class="mx-auto text-center py-2">
          ...
          <div class="d-none">
            @foreach($cities as $city)
                <p class="main-header-mobile-content-active__p"><a href="{{ route('site.change_city', $city->id) }}" class="mobile-d-menu-adress">{{ $city->name }}</a></p>
            @endforeach
        ...
        <div class="mx-auto text-center py-2">
          ...
          <div class="d-none">
            <p class="main-header-mobile-content-active__p py-1"><a href="{{ route('site.res.residences', 'all') }}" class="mobile-d-menu-residentials">Все комплексы</a></p>
            <p class="main-header-mobile-content-active__p py-1"><a href="{{ route('site.res.residences', 'all') }}" class="mobile-d-menu-residentials">Элитный</a></p>
            <p class="main-header-mobile-content-active__p py-1"><a href="{{ route('site.res.residences', 'all') }}" class="mobile-d-menu-residentials">Бизнес-класс</a></p>
            @foreach ($current_areas as $resArea)
                @if(in_array($resArea->id, $residenceArea))
